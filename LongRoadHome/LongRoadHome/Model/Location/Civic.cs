...
namespace uk.ac.dundee.arpond.longRoadHome.Model.Location
{
    public class Civic : Sublocation
    {
        ...
        public Civic(int sublocID, int maxItems, int maxAmount)
        {
        ...
        /// <summary>
        /// Creates a new Civic sublocation with the values passed
        /// </summary>
        ...
        {
            return new Civic(sublocID, maxItems, maxAmount);
        }

        /// <summary>
        /// Creates a new Civic sublocation with the string passed
        /// </summary>
