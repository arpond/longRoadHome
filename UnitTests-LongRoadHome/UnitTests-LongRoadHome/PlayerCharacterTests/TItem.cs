...
namespace UnitTests_LongRoadHome
{
    ...
    public class TItem
    {
        ...
        {
            Item item = new Item();
            String expected = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
        ...
        {
            String test1 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsTrue(Item.IsValidItem(test1), "Basic item should be valid");

            String test2 = "ID:1:2,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test2), "Should only have 1 ID");

            String test3 = "ID,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test3), "ID should have at least 1 item");

            String test4 = "ID:,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test4), "ID should not be null");

            String test5 = "ID:asdas,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test5), "ID should not be a string");

            String test6 = "ID:1.1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test6), "ID should not be a float");

            String test7 = "ID:-1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test7), "ID should be positive");

            String test8 = "ID:1,Name:TestItem:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test8), "Item should only have 1 Name");

            String test9 = "ID:1,Name,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test9), "Item should at least 1 Name");

            String test10 = "ID:1,Name:,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test10), "Name should not be null");

            String test11 = "ID:1,Name:TestItem,Amount:1:2,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test11), "Should only have 1 Amount");

            String test12 = "ID:1,Name:TestItem,Amount,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test12), "Amount should have at least 1 item");

            String test13 = "ID:1,Name:TestItem,Amount:,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test13), "Amount should not be null");

            String test14 = "ID:1,Name:TestItem,Amount:asdasd,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test14), "Amount should not be a string");

            String test15 = "ID:1,Name:TestItem,Amount:1.1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test15), "Amount should not be a float");

            String test16 = "ID:1,Name:TestItem,Amount:1,Description:test item 1:test item 1,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test16), "Item should only have 1 Description");

            String test17 = "ID:1,Name:TestItem,Amount:1,Description,ActiveEffect,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test17), "Item should at least 1 Description");

            String test18 = "ID:1,Name:TestItem,Amount:1,Description:,ActiveEffect,PassiveEffect,Requirements";
        ...
        public void Item_CheckFullStringIsValid()
        {
            ...
            String test2 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect:a,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test2), "If active effect has items they should be in groups of 3");

            String test3 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect:a:b,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test3), "If active effect has items they should be in groups of 3");

            String test4 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect:a:b:c:d,PassiveEffect,Requirements";
            Assert.IsFalse(Item.IsValidItem(test4), "If active effect has items they should be in groups of 3");

            String test5a = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect:" + PassiveEffect.TAG + ":" + PlayerCharacter.HEALTH + ":" + "10,PassiveEffect,Requirements";
            ...
            String test7 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect:a,Requirements";
            Assert.IsFalse(Item.IsValidItem(test7), "If passive effect has items they should be in groups of 3");

            String test8 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect:a:b,Requirements";
            Assert.IsFalse(Item.IsValidItem(test8), "If passive effect has items they should be in groups of 3");

            String test9 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect:a:b:c:d,Requirements";
            Assert.IsFalse(Item.IsValidItem(test9), "If passive effect has items they should be in groups of 3");

            String test10a = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect:" + ActiveEffect.TAG + ":" + PlayerCharacter.HEALTH + ":" + "10,Requirements";
            ...
            String test12 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements:asdasd";
            Assert.IsFalse(Item.IsValidItem(test12), "If Requirements has items they should be ints");

            String test13 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements:2:3:2";
            Assert.IsFalse(Item.IsValidItem(test13), "If Requirements has items there shouldn't be duplicates");
           
            String test14 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements:2:3::4";
            Assert.IsFalse(Item.IsValidItem(test14), "If Requirements has items none should be null");

            String test15 = "ID:1,Name:TestItem,Amount:1,Description:test item 1,ActiveEffect,PassiveEffect,Requirements:2:-3:3:4";
